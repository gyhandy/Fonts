...
from solver_purity import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lambda_combine', type=float, default=0, help='weight for lambda_combine')
    ...
    parser.add_argument("--lambda_triplet", default=1, type=float,help='weight for triplet_loss')
    parser.add_argument('--norm', type=str, default='instance', help='instance normalization or batch normalization')

    # parser.add_argument('--z_dim', default=1000, type=int, help='dimension of the representation z')
    parser.add_argument('--z_dim', default=2, type=int, help='dimension of the representation z')
    '''
    the weight for pose and background
    '''
    parser.add_argument('--z_content', default=0, type=int, help='dimension of the z_content in z')
    parser.add_argument('--z_size', default=0, type=int, help='dimension of the z_size in z')
    parser.add_argument('--z_font_color', default=0, type=int, help='dimension of the z_font_color in z')
    parser.add_argument('--z_back_color', default=2, type=int, help='dimension of the z_back_color in z')
    parser.add_argument('--z_style', default=0, type=int, help='dimension of the z_style in z')
    ...
    parser.add_argument('--viz_port', default=9097, type=str, help='visdom port number')
    ...
    parser.add_argument('--model_save_dir', default='/lab/tmpig23b/u/yao-data/generationAE/model/purity_backcolor',
                        type=str, help='output directory')
    parser.add_argument('--resume_iters', type=int, default=0, help='resume training from this step')

    parser.add_argument('--gather_step', default=4000, type=int, help='numer of iterations after which data is gathered for visdom')
    parser.add_argument('--display_step', default=4000, type=int, help='number of iterations after which loss data is printed and visdom is updated')
    parser.add_argument('--save_step', default=500, type=int, help='number of iterations after which a checkpoint is saved')

    parser.add_argument('--ckpt_dir', default='/lab/tmpig23b/u/yao-data/generationAE/model/purity_backcolor',
