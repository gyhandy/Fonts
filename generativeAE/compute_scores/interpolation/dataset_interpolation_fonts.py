...
class ilab_Nswap_imgfolder(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for idx, name in enumerate(name_list):
            labels['letter'][pics[idx]] = name.split('_')[0]
            labels['size'][pics[idx]] = name.split('_')[1]
            labels['fg'][pics[idx]] = name.split('_')[2]
            labels['bg'][pics[idx]] = name.split('_')[3]
            labels['style'][pics[idx]] = name.split('_')[4].split('.')[0]
