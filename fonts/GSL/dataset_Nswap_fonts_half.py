...
class ilab_Nswap_imgfolder(Dataset):
    ...
    def __init__(self, root, transform=None):
        ...
        self.Colors_half = {'red': (220, 20, 60), 'orange': (255,165,0), 'Yellow': (255,255,0), 'green': (0,128,0), 'cyan' : (0,255,255)}
        self.Colors_half = list(self.Colors_half.keys())
        # size 3
        self.Sizes = {'small': 80, 'medium': 100, 'large': 120}
        self.Sizes = list(self.Sizes.keys())
        self.Sizes_half = {'medium' : 100}
        ...
        for roots, dirs, files in os.walk(os.path.join(self.root, 'i', 'medium', 'red', 'orange')):
            cates = dirs
            break
        self.All_fonts_half = cates
        # letter 52
        self.Letters = [chr(x) for x in list(range(65, 91)) + list(range(97, 123))]
        self.Letters_group_1 = self.Letters[0 : 10] # half size
        self.Letters_group_2 = self.Letters[10 : 20] # half font colo
        self.Letters_group_3 = self.Letters[20 : 30] # half back color
        self.Letters_group_4 = self.Letters[30 : 40] # half style
        self.Letters_group_5 = self.Letters[40 : ] # all half
