...
from solver_unsup_Nswap_fonts_half_content import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='fonts_3content', type=str, help='dataset name')
    # parser.add_argument('--image_size', default=64, type=int, help='image size. now only (64,64) is supported')
    parser.add_argument('--num_workers', default=32, type=int, help='dataloader num_workers')

    parser.add_argument('--viz_on', default=True, type=str2bool, help='enable visdom visualization')
    parser.add_argument('--viz_name', default='fonts_3content', type=str, help='visdom env name')
    parser.add_argument('--viz_port', default=8097, type=str, help='visdom port number')
    parser.add_argument('--save_output', default=True, type=str2bool, help='save traverse images and gif')
    parser.add_argument('--output_dir', default='/home2/PycharmProjects_backup/fonts/outputs', type=str, help='output directory')
    ...
    # parser.add_argument('--model_save_dir', default='checkpoints', type=str, help='output directory')
    parser.add_argument('--model_save_dir', default='/home2/PycharmProjects_backup/fonts/checkpoints', type=str, help='output directory')
    # parser.add_argument('--resume_iters', type=int, default=0, help='resume training from this step')
    parser.add_argument('--resume_iters', type=int, default=50000, help='resume training from this step')
