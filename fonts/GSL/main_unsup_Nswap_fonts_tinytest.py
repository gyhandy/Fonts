...
from solver_unsup_Nswap_fonts_tinytest import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--viz_name', default='fonts_Nswap_tinytest', type=str, help='visdom env name')
    ...
    parser.add_argument('--model_save_dir', default='checkpoints', type=str, help='output directory')
    parser.add_argument('--resume_iters', type=int, default=80000, help='resume training from this step')
