...
class ilab_Nswap_imgfolder(Dataset):
    ...
    def __init__(self, root, transform=None):
        ...
        '''refer'''
        # color 10
        self.back_Colors = {'red': (220, 20, 60), 'Yellow': (255, 255, 0), 'green': (0, 128, 0),
          'silver': (192, 192, 192),
          'blue': (0, 0, 255), 'pink': (255, 192, 203)
          }
        self.back_Colors = list(self.back_Colors.keys())
        self.fg_Colors = {'red1': (255, 106, 106), 'Yellow1': (205, 205, 0), 'green1': (34, 139, 34),
          'silver1': (128,128,128),
        ...
        for roots, dirs, files in os.walk(os.path.join(self.root, 'a', 'small', 'blue1', 'blue')):
            cates = dirs
            break
...
def return_data(args):
    ...
    if name.lower() == '3dchairs':
        ...
        if args.use_server == True:
            ...
            # root = '/home2/fonts_dataset_version2'
            root = '/lab/tmpig23b/u/gan/fonts_dataset_version2'
