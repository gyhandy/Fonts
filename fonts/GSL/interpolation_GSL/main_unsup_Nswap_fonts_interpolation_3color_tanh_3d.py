...
from solver_unsup_Nswap_fonts_interpolation_3color_tanh_3d import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--z_back_color', default=3, type=int, help='dimension of the z_back_color in z')
    parser.add_argument('--z_style', default=5, type=int, help='dimension of the z_style in z')
    ...
    parser.add_argument('--viz_name', default='fonts_Nswap_interpolation_rgb_tanh_3d', type=str, help='visdom env name')
