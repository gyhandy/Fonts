...
from solver_Fonts_checkz import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--viz_name', default='Fonts_checkz', type=str, help='visdom env name')
    parser.add_argument('--viz_port', default=8097, type=str, help='visdom port number')
    parser.add_argument('--save_output', default=False, type=str2bool, help='save traverse images and gif')
    ...
    parser.add_argument('--save_step', default=200000, type=int, help='number of iterations after which a checkpoint is saved')

    parser.add_argument('--ckpt_dir', default='checkpoints', type=str, help='checkpoint directory')
    # parser.add_argument('--ckpt_name', default='last', type=str, help='load previous checkpoint. insert checkpoint filename')
    # parser.add_argument('--ckpt_name', default='tcvae_last', type=str,
    #                     help='load previous checkpoint. insert checkpoint filename')
    # parser.add_argument('--ckpt_name', default='tcvae_110000', type=str,
    #                     help='load previous checkpoint. insert checkpoint filename')
    parser.add_argument('--ckpt_name', default='tcvae_260000', type=str,
                        help='load previous checkpoint. insert checkpoint filename')
