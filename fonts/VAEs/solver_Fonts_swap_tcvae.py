...
from model_tcvae import BetaVAE_H, BetaVAE_B
    ...
    def train(self):
        ...
        while not out:
            for sup_package in self.data_loader:
                ...
                #iso-vae 34
                #110000
                # new = [36, 78, 23, 51, 32, 66, 18, 77, 71, 82, 53, 26, 91, 61, 48, 72, 34, 57, 75, 37, 83, 81, 62, 3,
                #        20, 93, 7, 80, 6, 55, 15, 42, 95, 17, 38, 12, 88, 21, 22, 60, 94, 33, 25, 31, 65, 54, 45, 89, 56,
                #        98, 4, 96, 40, 46, 44, 39, 58, 13, 43, 63, 67, 16, 11, 68, 74, 0, 64, 99, 47, 73, 9, 70, 50, 85,
                #        8, 29, 92, 84, 86, 30, 5, 27, 35, 87, 41, 10, 59, 19, 76, 24, 69, 28, 2, 97, 14, 52, 79, 90, 49,
                #        1]
                # 260000
                new = [84, 79, 93, 71, 45, 47, 4, 72, 1, 48, 99, 30, 15, 16, 57, 25, 20, 92, 51, 89, 65, 81, 10, 64, 8,
                       9, 12, 35, 21, 29, 61, 43, 91, 28, 82, 83, 94, 75, 76, 59, 36, 6, 2, 78, 3, 55, 80, 22, 41, 53,
                       31, 86, 90, 13, 49, 17, 39, 14, 50, 74, 26, 58, 77, 38, 23, 63, 85, 24, 33, 42, 32, 18, 69, 27,
                       73, 11, 19, 5, 66, 54, 70, 88, 97, 60, 52, 34, 46, 0, 95, 67, 98, 62, 37, 96, 40, 87, 7, 44, 56,
                       68]
                ...
                A_z_1_vae = torch.tensor([[A_z_vae[0][i] for i in content_idx]]).to(self.device)  # 0-200
