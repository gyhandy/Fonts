...
'''change depend on different model ae, b vae, tc vae'''
# from model_checkz import BetaVAE_H, BetaVAE_B
from model_tcvae import BetaVAE_H, BetaVAE_B

from dataset_Fonts_checkz import return_data
...
class Solver(object):
    ...
    def train(self):
        ...
        while not out:
            for x, x_name in self.data_loader:
                self.global_iter += 1
                pbar.update(1)
                ...
                for item in range(len(x)):
                    ...
                    # f = open(self.log_dir + '/name_z_tcvae.txt', 'a')
                    # f = open(self.log_dir + '/name_z_tcvae_110000.txt', 'a')
                    f = open(self.log_dir + '/name_z_tcvae_260000.txt', 'a')
