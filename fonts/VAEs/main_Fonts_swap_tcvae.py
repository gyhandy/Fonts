...
from solver_Fonts_swap_tcvae import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--viz_name', default='Fonts_swap', type=str, help='visdom env name')
    ...
    parser.add_argument('--ckpt_name', default='260000_tcvae', type=str,
