...
from solver_dsprites_swap import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_iter', default=1e9, type=float, help='maximum training iteration')
    ...
    parser.add_argument('--dataset', default='dsprites_unsup_nswap', type=str, help='dataset name')
    ...
    parser.add_argument('--viz_name', default='dsprites_swap', type=str, help='visdom env name')
    ...
    # parser.add_argument('--ckpt_name', default='170000', type=str, help='load previous checkpoint. insert checkpoint filename')
