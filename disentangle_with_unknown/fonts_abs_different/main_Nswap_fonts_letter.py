...
from solver_Nswap_fonts_letter import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lambda_dif', default=1, type=float, help='lambda_recon')
    ...
    parser.add_argument('--viz_name', default='fonts_Nswap_letter', type=str, help='visdom env name')
