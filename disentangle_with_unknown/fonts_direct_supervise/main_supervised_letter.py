...
from solver_supervised_letter import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrain_iter', default=1e5, type=float, help='maximum training iteration to classify the letter in image')
    ...
    parser.add_argument('--lambda_latent_class', type=float, default=1, help='weight for lambda_combine')
    parser.add_argument('--lambda_image_class', default=0.1, type=float, help='lambda_recon')
    ...
    parser.add_argument('--project_name', default='directly_supervise', type=str, help='visdom env name')
    parser.add_argument('--viz_name', default='pretrain_swap_letter', type=str, help='visdom env name')


    '''
    save model
    '''
    parser.add_argument('--resume_pretrain_iters', type=int, default=1e5, help='resume image classifier from this step')
    parser.add_argument('--resume_iters', type=int, default=0, help='resume training from this step')

    parser.add_argument('--gather_step', default=1e4, type=int, help='numer of iterations after which data is gathered for visdom')
    ...
    parser.add_argument('--model_save_dir', default='/lab/tmpig23b/u/yao-data', type=str, help='output directory')
    parser.add_argument('--ckpt_dir', default='/lab/tmpig23b/u/yao-data', type=str, help='checkpoint directory')
