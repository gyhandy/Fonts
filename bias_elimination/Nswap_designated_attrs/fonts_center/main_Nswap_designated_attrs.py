...
import numpy as np
import torch
from solver_Nswap_designated_attrs import Solver
...
if __name__ == "__main__":
    ...
    '''
    parser.add_argument('--disentangle_list', default=['content', 'size', 'font_color', 'back_color', 'style'],
                        type=str, help='the attributes in dataset')
    ...
    parser.add_argument('--disentangle_content', default='True', type=str2bool, help='whether disentangle content')
    parser.add_argument('--disentangle_size', default='False', type=str2bool, help='whether disentangle size')
    parser.add_argument('--disentangle_font_color', default='False', type=str2bool, help='whether disentangle font_color')
    parser.add_argument('--disentangle_back_color', default='False', type=str2bool, help='whether disentangle back_color')
    parser.add_argument('--disentangle_style', default='False', type=str2bool, help='whether disentangle style')
    ...
    parser.add_argument('--viz_name', default='fonts_center', type=str, help='visdom env name')
    ...
    parser.add_argument('--ckpt_dir', default='/lab/tmpig23b/u/yao-data/Nswap_designated_attrs', type=str, help='checkpoint directory')
