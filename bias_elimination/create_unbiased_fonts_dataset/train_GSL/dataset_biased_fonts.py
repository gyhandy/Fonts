...
class ilab_Nswap_imgfolder(Dataset):
    ...
    def __init__(self, root, transform=None):
        ...
        self.All_fonts = list(
            {'ani', 'dejavusans', 'freemono', 'freeserif', 'karumbi', 'liberationmono', 'liberationserif', 'loma',
             'norasi', 'notomono', 'notosanscjkhk',
             'notoserifcjkjp', 'padauk', 'padmaabold11', 'pagul', 'phetsarathot', 'purisa', 'sahadeva', 'sawasdee',
             'tlwgtypist', 'ubuntu', 'waree'})
        # size 3
