...
class ilab_Nswap_imgfolder(Dataset):
    ...
    def findN(self, index):
        ...
        C_back_color = random.choice(self.back_color_set)
        ...
        A_back_color = random.choice(temp_back_colors)
        ...
        B_back_color = random.choice(temp_back_colors)
        ...
        D_back_color = random.choice(temp_back_colors)
        ...
        F_back_color = random.choice(temp_back_colors)
        '''SAME font'''
        F_font = C_font
...
def return_data(args):
    ...
    if name.lower() == '3dchairs':
        ...
        root = '/lab/tmpig23b/u/yao-data/dataset/fonts_dataset_version2'
