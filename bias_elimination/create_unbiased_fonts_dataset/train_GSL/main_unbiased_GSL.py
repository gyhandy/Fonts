...
from solver_unbiased_fonts import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--viz_name', default='unbiased', type=str, help='visdom env name')
    parser.add_argument('--viz_port', default=8097, type=str, help='visdom port number')
    parser.add_argument('--save_output', default=True, type=str2bool, help='save traverse images and gif')
    parser.add_argument('--output_dir', default='/lab/tmpig23b/u/yao-data/fonts_Nswap/outputs/version2',
                        type=str, help='output directory')
    '''
    save model
    '''
    parser.add_argument('--model_save_dir', default='/lab/tmpig23b/u/yao-data/fonts_Nswap/model/version2',
                        type=str, help='output directory')
    parser.add_argument('--resume_iters', type=int, default=270000, help='resume training from this step')
    ...
    parser.add_argument('--ckpt_dir', default='/lab/tmpig23b/u/yao-data/fonts_Nswap/model/version2',
    ...
    parser.add_argument('--which_server', default='21', type=str,
