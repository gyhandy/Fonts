...
parser.add_argument('--data',default='/lab/tmpig23b/u/zhix/classification_interpolation', help='path to dataset')
parser.add_argument('-a', '--arch', metavar='ARCH', default='/lab/tmpig23b/u/zhix/alexnet_big/',
