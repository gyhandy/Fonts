...
from solver_unsup_Nswap_fonts_interpolation_3color_tanh_3d_itploss import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='font_dataset_little_240', type=str, help='dataset name')
    ...
    parser.add_argument('--viz_name', default='fonts_Nswap_interpolation_rgb_tanh', type=str, help='visdom env name')
    parser.add_argument('--viz_port', default=8097, type=str, help='visdom port number')
    parser.add_argument('--save_output', default=True, type=str2bool, help='save traverse images and gif')
    parser.add_argument('--output_dir', default='/lab/tmpig23b/u/he-data/GSL_classification/outputs2', type=str, help='output directory')
    '''
    save model
    '''
    # parser.add_argument('--model_save_dir', default='checkpoints', type=str, help='output directory')
    parser.add_argument('--model_save_dir', default='/lab/tmpig23/u/he-code/GSL_classification/checkpoints', type=str, help='output directory')
    parser.add_argument('--resume_iters', type=int, default=30600, help='resume training from this step')

    parser.add_argument('--gather_step', default=200, type=int, help='numer of iterations after which data is gathered for visdom')
    parser.add_argument('--display_step', default=200, type=int, help='number of iterations after which loss data is printed and visdom is updated')
    parser.add_argument('--save_step', default=200, type=int, help='number of iterations after which a checkpoint is saved')

    parser.add_argument('--ckpt_dir', default='/lab/tmpig23/u/he-code/GSL_classification/checkpoints3', type=str, help='checkpoint directory')
    parser.add_argument('--ckpt_name', default='30800-Auto.ckpt', type=str, help='load previous checkpoint. insert checkpoint filename')
