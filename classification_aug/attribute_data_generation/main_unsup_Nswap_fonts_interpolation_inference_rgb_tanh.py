...
from solver_unsup_Nswap_fonts_interpolation_inference_rgb_tanh import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='font_dataset_small_540', type=str, help='dataset name')
    ...
    parser.add_argument('--model_save_dir', default='checkpoints', type=str, help='output directory')
    parser.add_argument('--resume_iters', type=int, default=32200, help='resume training from this step')
    ...
    parser.add_argument('--ckpt_name', default='30000-Auto.ckpt', type=str, help='load previous checkpoint. insert checkpoint filename')
    ...
    parser.add_argument('--classification_dir',default='/lab/tmpig23b/u/he-data/classification_dataset1/train_little_aug3',type=str)
    parser.add_argument('--aug_data_set',default=True,type=bool)
